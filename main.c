...
/////////////////////////////////////////////////////////////////////////////////
//Timer2 ISR for writting ADC/PWR to LCD//
/////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////
//INT0 ISR for Tachometer counting rotations//
/////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////
//UART0 RX ISR for receiving GPS information
/////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////
//TIMER0 ISR for timestamps on log file//
/////////////////////////////////////////////////////////////////////////////////
ISR(TIMER0_OVF_vect){
    char temp[6];
...
int main(void){
	...
	//Initialization for UART0, UART1
	uart_init();
	uart1_init();
	...
	EIMSK |= _BV(INT0);     //interrupt mask for INT0 (tachometer)
...
/////////////////////////////////////////////////////////////////////////////////
//Send UART0 to turn on GPS
/////////////////////////////////////////////////////////////////////////////////	
	
	/***************UART PORTION************************/
	//uart_puts("AT+CGNSSEQ?");
	uart_puts("AT\r");   //Baud rate AT command
	
	_delay_ms(50);
	
	uart_puts("AT+CGNSPWR=1\r");  //Turn on GPS AT Command
	
	_delay_ms(50);
	
	uart_puts("AT+CGNSINF\r");   //Get GPS information AT Command
    ...
    {  
		...
		if ((PINE & 0x04) == 1){
			uart1_puts("go");  // placeholder for throttle command
		}
		
		if ((PINE & 0x05) == 1){
			uart1_puts("cruise");  // placeholder for cruise control command
		}	
		
		if (lap == latitude){     //button 2 increments lap counter
			count++;
			_delay_ms(
		}
